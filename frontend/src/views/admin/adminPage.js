    ...
    return(
        <Grid>
            ...
            <Grid className="grid-card">
                <Card>
                    <CardContent sx={{ maxWidth: '70vw', maxHeight: '55vh' }} className={"card_seperator"}>
            ...
            <Grid className="grid-card">
                <Card>
                    <CardContent sx={{ maxWidth: '70vw', maxHeight: '55vh' }} className={"card_seperator"}>
                    <Typography gutterBottom variant="h5" component="div" display={"flex"} margin={"auto"}>
                        Login Statistics 
                     </Typography>
                    <CardMedia
...
export default function Admin() {
    return (
        <>
            <Grid alignContent={"center"} display="flex"><h1>Admin Page</h1></Grid>
            <br></br>
